    ...
    *,
    ...
    lines: list[str] = [
        ...
        *_bullet_list(read_paths),
        ...
        "  Write: do not create or edit report files in this session.",
        "",
        "FORBIDDEN FILES / RED ZONES:",
        *_bullet_list(red_zones + forbidden_paths),
        ...
        "  - Do not create or edit the external report file during this read-only validation.",
        "  - Do not ask for file-write permission for the report.",
        "",
        "REQUIRED TESTS:",
        ...
        "  Reference only — do not write this file yourself. The operator archives your",
        "  final Markdown response externally after the session.",
        "",
        "FINAL RESPONSE REQUIREMENT:",
        "  When finished, return the complete analysis report as your final response in Markdown.",
        "  Do not create or edit files for the report during this read-only validation.",
        "  Do not ask for file-write permission.",
        "  The operator/runtime will archive your final answer outside this Claude Code session.",
        "",
        "  Include at minimum:",
        "  - A title (# heading)",
        ...
        "",
        "FINAL REPLY FORMAT:",
        "  Your entire final response should be the Markdown report itself.",
        "  If you cannot proceed safely, reply with a single line starting 'BLOCKER:'.",
        "",
        "STOP CONDITIONS:",
        "  - Stop after returning the complete Markdown report in your final response.",
