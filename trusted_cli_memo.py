    ...
    *,
    ...
    lines: list[str] = [
        ...
        *_bullet_list(read_paths),
        ...
        "  Write: external report ONLY via stdout REPORT_FILE_WRITE bridge (see below).",
        "",
        "FORBIDDEN FILES / RED ZONES:",
        *_bullet_list(red_zones + forbidden_paths),
        ...
        "  - Emit your analysis report via the REPORT OUTPUT METHOD below.",
        "",
        "FORBIDDEN ACTIONS:",
        ...
        "  Target path must be under the Ai-Report write allowlist:",
        *_bullet_list(roots),
        "",
        "REPORT OUTPUT METHOD — IMPORTANT:",
        "  You have tools enabled for reading/searching the repo only.",
        "  Do NOT use Claude Code Write/Edit tools to create the external report.",
        "  Do NOT ask for permission to write the report file.",
        "  The runtime will save your report from stdout.",
        "",
        "  To write the report, output exactly one REPORT_FILE_WRITE_BEGIN /",
        "  REPORT_FILE_WRITE_END block in your final response:",
        "",
        "    REPORT_FILE_WRITE_BEGIN",
        f"    Path: {expected_output_path or '<absolute .md path under Ai-Report roots>'}",
        ...
        "",
        "  The worker runtime validates the path, writes the .md file, and converts",
        "  your output to REPORT_READY for the coordinator.",
        "",
        "  If you cannot output the report bridge, return exactly:",
        "    BLOCKER: trusted CLI report bridge output failed",
        "",
        "FINAL REPLY FORMAT:",
        "  Do not emit REPORT_READY yourself — the runtime emits it after saving the",
        "  REPORT_FILE_WRITE_BEGIN/END block above.",
